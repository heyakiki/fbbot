            ...
            if ( !isNaN(msg) && msg.length == 8)
              {
                ...
                if (scnum==1){ansmsg="恭喜抽中上上籤(憑籤詩回NOVA免費送LED隨行燈乙份)，今年財神眷顧，不管是就業創業，存款大增富貴無窮。";}
                if (scnum==2){ansmsg="恭喜抽中大吉(憑籤詩回NOVA免費送LED隨行燈乙份)，今年運勢高漲，荷包滿滿，事業順利愛情更大豐收。";}
                if (scnum==3){ansmsg="恭喜抽中小吉(憑籤詩回NOVA免費送LED隨行燈乙份)，今年吉星照命財運大增，貴人協力下財運大漲，運勢一路攀升。";}
                if (scnum==4){ansmsg="恭喜抽中吉(憑籤詩回NOVA免費送LED隨行燈乙份)， 今年喜事一波接一波，財路大開，事業發展迅速，名利兼收。";}
                if (scnum==5){ansmsg="恭喜抽中大吉(憑籤詩回NOVA免費送LED隨行燈乙份)，今年桃花大開情場得意，與戀人甜甜蜜蜜，與家人和和睦睦，超完美。";}
                if (scnum==6){ansmsg="恭喜抽中小吉(憑籤詩回NOVA免費送LED隨行燈乙份)，今年事業運平穩，有貴人幫助，無論加薪或升職運都有不俗的提升。";}
                if (scnum==7){ansmsg="恭喜抽中上上籤(憑籤詩回NOVA免費送LED隨行燈乙份)，今年吉星的庇佑，事業上突飛猛進，升職加薪，得到上司的賞識與提拔";}
                if (scnum==8){ansmsg="恭喜抽中上上籤(憑籤詩回NOVA免費送LED隨行燈乙份)，財祿雙至，不僅會富還會貴，權利名利上會跨進一大步，財運運勢旺盛。";}
                if (scnum==9){ansmsg="恭喜抽中大吉(憑籤詩回NOVA免費送LED隨行燈乙份)，雀財吉星相助，財運沖天事業沖天，真愛找上門。";}
                
              }
              else
                {
                  ansmsg="原來外星人 4 ni @?@ , 穿越平行時空來到這裡 !";
                }
